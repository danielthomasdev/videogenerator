...
Replace the following code with the following code to use OpenAI's GPT-3.5-Turbo model. Could do gpt-4 as well now that I have access.
    ...
    */
    ...
    <div class="row">
        <div class="col-12">
            <h1>Neat-o AI Video Generator</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <form method="post" enctype="multipart/form-data">
                <div class="row pt-5">
                    <div class="col">
                        <?php if ($text_article == null): ?>
                            <div class="mb-3">
                                <label for="makeItAbout" class="form-label">What do you want your video to be about?</label>
                                <input class="form-control" type="text" name="makeItAbout">
                            </div>
                            <div class="col-auto">
                                <button type="submit" name="submit" class="btn btn-primary mb-3">Make Me A Video!</button>
                            </div>
                        <?php else: ?>
                            <div class="mb-3">
                                <input type="hidden" name="text_article" value="<?= $text_article; ?>">
                                <input type="hidden" name="makeItAbout" value="<?= $_POST['makeItAbout']; ?>">
                                Script:<br>
                                <?= $text_article; ?>
                            </div>
                            <div class="mb-3">
                                <label for="imagesAbout" class="form-label">What do you want the images to be about?</label>
                                <input class="form-control" type="text" name="imagesAbout">
                            </div>
                            <div class="mb-3">
                                <label for="videoTitle" class="form-label">What's the video title text?</label>
                                <input class="form-control" type="text" name="videoTitle">
                            </div>
                            <div class="col-auto">
                                <button type="submit" name="approve" class="btn btn-primary mb-3">Looks good, continue generating the video!</button>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
